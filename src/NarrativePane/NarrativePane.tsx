...
const NarrativePane = ({ output }: NarrativePaneProps) => (
  <div className="h-full p-4">
    ...
    <p className="mb-2">
      ...
      see is biased. Because data is generated by humans, all data is biased. 
      ...
      you get a song you don't like. But, algorithms are also used to
      <a href="https://www.propublica.org/article/machine-bias-risk-assessments-in-criminal-sentencing">determine how much money defendants must pay</a> to leave jail,
      or to <a href="https://www.govx.digital/technology/fuck-the-algorithm-protests-put-government-use-of-ai-in-spotlight">predict students' exam scores</a>.
    </p>
    <p className="mb-2">
